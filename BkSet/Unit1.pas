...
procedure TFmain.BdnLoadClick(Sender: TObject);
...
procedure TFmain.BdnLoadFkClick(Sender: TObject);
var vFileName:string;
begin
    vFileName:='';
    with openDialog1 do
...
procedure TFmain.CBfmNameClick(Sender: TObject);
begin
...
procedure TFmain.CBRDelimiterClick(Sender: TObject);
begin
   gpRecDe:=chr(13)+chr(10);
end;

procedure TFmain.CBFDelimiterClick(Sender: TObject);
begin
   gpFieldDe:=Label13.Caption;
end;
...
procedure TFmain.SD1CanClose(Sender: TObject; var CanClose: Boolean);
begin
  Kayit_Tiklandi:=True;
end;
