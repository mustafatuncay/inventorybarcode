object FrmDlgOpSearchBankExtre: TFrmDlgOpSearchBankExtre
  Left = 243
  Top = 159
  BorderStyle = bsDialog
  Caption = 'FrmDlgOpSearchBankExtre'
  ClientHeight = 317
  ClientWidth = 639
  Color = clBtnFace
  ...
  object Grd1: TDBAdvStringGrid
    ...
    OnGetAlignment = Grd1GetAlignment
    ...
    Fields = <
      ...
      item
        ...
        Color = clWindow
        Editor = edNormal
        FieldName = 'OpDefinition'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        Font.Style = []
        Title = 'A'#231#305'klama'
        ReadOnly = False
        ShowBands = True
        SpinMin = 0
        SpinMax = 0
